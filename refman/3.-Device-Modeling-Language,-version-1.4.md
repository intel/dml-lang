...
[Register Objects](4.-Libraries-and-Built-ins#register-objects).
...
An [`attribute` object](4.-Libraries-and-Built-ins#attribute-objects) in DML represents a
...
The [`init` template](4.-Libraries-and-Built-ins#init) is often useful together with
...
A [`connect` object](4.-Libraries-and-Built-ins#connect-objects)
...
This is done through [`interface` objects](4.-Libraries-and-Built-ins#interface-objects).
...
See Section [Universal Templates](4.-Libraries-and-Built-ins#universal-templates)
for details.)
...
The general form of a [`field` object](4.-Libraries-and-Built-ins#field-objects)
declaration is
...
method, as provided by the [`object` template](4.-Libraries-and-Built-ins#object).
